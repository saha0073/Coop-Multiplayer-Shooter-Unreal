...
void ASTrackerBot::Tick(float DeltaTime)
{
	...
	if (HasAuthority() && !bExploded) {
		...
		if (DistanceToarget <= RequiredDistanceToTarget) {
			...
			//GEngine->AddOnScreenDebugMessage(-1, 15.0f, FColor::Yellow, FString::Printf(TEXT("authority Fire() in FPSCharacter.cpp %s"), ForceDirection.ToString()));
			//UE_LOG(LogTemp, Log, TEXT("Rot is %s"), *ForceDirection.ToString());
		}
